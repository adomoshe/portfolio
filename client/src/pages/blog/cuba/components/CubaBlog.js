    ...
    <div className="row justify-content-center">
      <div className="col-sm-6">
        ...
        <p>
          ...
          among them journalistic activities, which I claimed was the purpose of
          my trip.
        </p>
        <br />
        <br />
        ...
        <p>
          ...
          lifting of the travel ban are instituted mostly to scare off would-be
        ...
        <br />
        <p>
          &emsp;The first stumbling block to your Cuba trip is merely a figment.
          A concern much more palpable is that until 2015, the Department of
          State placed Cuba on the State Sponsors of Terrorism list, alongside
          Libya, Iraq, South Yemen, and Syria. Cuba's 35 year stint on this list
          has some implications directly related to your travels. This means the
        ...
        <br />
        <p>
          &emsp;Another important thing to remember concerning cash is that Cuba
          has two currencies, the Convertible Cuban Peso (CUC) which is linked
          to the American dollar as discussed above, and is used exclusively by
        ...
        <p>
          ...
          quickly be identified as a tourist and subject to the CUC prices. This
          will only really affect you at museums, where entrance fee is
        ...
        <p>
          ...
          allowed to conduct business in Cuba so you can forget about your snap
          streaks. The only way to get an internet connection is to buy a
          Tarjeta Propia at ETECSA or from local kids on the street and you can
          access wifi at various areas throughout the city.
        </p>
        <br />
        <br />
        ...
        <p>
          ...
          touristy areas in the city, restaurants nearby serviced mostly locals.
          What they lacked in curb appeal they more that compensated for in
          taste. As for the price, it seemed a little high, at around 20-25 so I
          was not sure in which currency. But, I gladly discovered it to be in
          CUP. Since I did not carry any CUP on me I was charged 1.5 CUC, the
        ...
        <p>
          ...
          Cuba struggled from a weak economy and declines in demand for its main
        ...
        <p>
          ...
          walk by and hand out menus for the past thirty minutes and you realize
          its a state run spot. My only experience with this situation was at
          Plaza de Armas in Old Havana where after admiring the view for a long
          while, a group of older ladies informed me that I was going to have to
          be much more proactive throughout this dining experience. Other
          restaurants were crowded and I had already secured a nice table
          outside, so I decided to get out my wallet and head to the bar. Paying
          at the bar and adding a generous tip seemed to correct the situation
          and I was quickly enjoying my Cigar and Empanada meal.
        </p>
        <br />
        <br />
        ...
        <br />
        <p>
          &emsp;Fabrica de Arte Cubano was highly rated and after going twice, I
          would rate as a must. The building looks like a warehouse from
        ...
        <p>
          ...
          affordable and and offers many spots to visit besides Havana. You can
          really tailor your trip to your comfort level, you can visit different
          parts of the island or you can opt to stay in Havana or even relax at
          an all inclusive in Varadero for a while.
        </p>
        <br />
        <br />
        <p>
