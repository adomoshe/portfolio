    ...
    return (
      <div className="row justify-content-center" style={styles.row}>
        ...
        <div className="col-sm-6">
          ...
          <Link to={`${this.props.match.url}/cuba`} style={styles.link}>
            <h3>
          ...
          <Link to={`${this.props.match.url}/spring-break`} style={styles.link}>
            <h3>Spring Break Road Trip Into Portugal</h3>
          </Link>
          <Link to={`${this.props.match.url}/dublin`} style={styles.link}>
            <h3>Dublin, Ireland</h3>
          </Link>
          <h3 style={styles.dates}>&emsp;January, 2016</h3>
          <Link to={`${this.props.match.url}/week_2`} style={styles.link}>
            <h3>Week 2 in Barcelona (Montserrat, Sailing, and Futbol)</h3>
          </Link>
          <Link to={`${this.props.match.url}/arrival`} style={styles.link}>
