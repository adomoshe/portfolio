...
const BlogHome = ({ match }) => (
  <div className="row justify-content-center" style={styles.row}>
    ...
    <div className="col-sm-6">
      ...
      <Link to={`${match.url}/cuba`} style={styles.link}>
        <h3>Important Pre-Departure and General Information (Trump Update)</h3>
      </Link>
      <h2 style={styles.category}>Spain (Study Abroad)</h2>
      <h3 style={styles.dates}>&emsp;March, 2016</h3>
      <Link to={`${match.url}/spring-break`} style={styles.link}>
        <h3>Spring Break Road Trip Into Portugal</h3>
      </Link>
      <Link to={`${match.url}/dublin`} style={styles.link}>
        <h3>Dublin, Ireland</h3>
      </Link>
      <h3 style={styles.dates}>&emsp;January, 2016</h3>
      <Link to={`${match.url}/week_2`} style={styles.link}>
        <h3>Week 2 in Barcelona (Montserrat, Sailing, and Futbol)</h3>
      </Link>
      <Link to={`${match.url}/arrival`} style={styles.link}>
